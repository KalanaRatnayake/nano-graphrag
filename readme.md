...
`nano-graphrag-cpp` is a minimal, hackable C++ implementation of [GraphRAG](https://arxiv.org/pdf/2404.16130), inspired by the Python [nano-graphrag](https://github.com/gusye1234/nano-graphrag) project. It focuses on:
...
- Pluggable graph storage (in-memory, Neo4j, NetworkX, etc.)
- Simple, extensible APIs for RAG, entity extraction, and graph-based retrieval
- Out-of-the-box support for OpenAI, local, and hash-based embeddings
...
2. Set embedding and LLM strategies (OpenAI, hash, etc.)
...
> **Note:** This repo is pure C++ and tracks the Python reference for feature parity. See the Python version for more advanced graph/entity features.
...
- [SQLite3](https://www.sqlite.org/) (optional, for persistent storage)
...
Class explanations and design notes are in the docs folder:
- [GraphRAG architecture and API](./docs/README.md)
- [Vector storage and nano-vectordb-cpp](./docs/benchmark-en.md)
- [Entity extraction and graph storage](./docs/benchmark-dspy-entity-extraction.md)

### C++ API Docs
- [Embedding strategies](./docs-cpp/embedding.md)
- [LLM strategies](./docs-cpp/llm.md)
- [Chunking operations](./docs-cpp/operations_chunking.md)
- [Tokenization operations](./docs-cpp/operations_tokenize.md)
- [Storage backends](./docs-cpp/storage.md)
